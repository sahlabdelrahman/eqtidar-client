...
const ServicesConfig: ServicesComponentProps = {
    ...
    subServices: [
        ...
        { id: 1, text: "تسجيل شهادة الوقف" },
        { id: 2, text: "فتح حساب بنكي للوقف" },
        { id: 3, text: "تقديم استشارات وقفية" },
        { id: 4, text: "صياغة العقود" },
        { id: 5, text: "توفير أصول وقفية" },
        { id: 6, text: "تشغيل وقف" },
        { id: 7, text: "إدارة غلة وقف" },
        { id: 8, text: "استبدال وقف متعطل" },
        {
            id: 9,
            text: "دورات تدريبية للواقفين والعاملين في القطاع الوقفي",
        },
        { id: 10, text: "صياغة العقود" },

        { id: 11, text: "تسويق وقف قائم" },
        { id: 12, text: "الإبراز الاعلامي للوقف" },
    ],
